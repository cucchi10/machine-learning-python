...
for index, i in enumerate(categorias):
    for k in range(1,10): #son 10 imagenes por carpeta
        url=(f'redes convolusionales/{i}/{k}.jpg')
        img=cv2.imread(url,0) #almaceno cada imagen en escala de grises
...
test=cv2.imread("redes convolusionales/test.jpg",0) # imporoto la prieba en gris
